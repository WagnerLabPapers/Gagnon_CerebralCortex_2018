...
% Script trocear hippocampus y calcular volumenes
%
...
% we are going to run through all the subjects. 
    ...
    for nsub = 1:numSub
        ...
        for h=1:length(hd.hemi)
            ...
            if hd.WRITE_MGZ > 0 % == true write the volumes to file
                % disp('LLamando a la funcion para que escriba fisicamente los segmentos');
    ...
    % one that made the call and return to hip_lanzar

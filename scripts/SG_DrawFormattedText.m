function [nx, ny, textbounds] = SG_DrawFormattedText(win, tstring, sx, sy, color, wrapat,spacing)
...
% 07/02/08  Added spacing variable (AS) - uses multiples of textSize
...
if exist('spacing','var')
    theight = Screen('TextSize', win)*spacing;
else

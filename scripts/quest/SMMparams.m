function expParams = STAI_Tparams(w,rect,p,PrePost)
...
%% Experimenter-defined parameters:
    ...
    % (for instance, if you have a 1-5 scale but want it to be 0-4 or -2-2 you can enter 1 or 3) 
        rNumShift = 1;  % shift numeric scale leftward by this # (e.g., 1 shifts 1-7 scale to 0-6)

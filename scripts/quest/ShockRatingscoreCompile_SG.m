function [allQuestsummaryNames,allQuestsummaryScores,allQuestsummaryRTs,...
    allQuestnames_ALL,allQuestsubscales_ALL,allQuestscores_ALL,allQuestrts_ALL] = ShockRatingscoreCompile_SG()

filename = 'AssocMem_ShockBlockRatings.csv';

for block_num = 1:4

    
    clearvars -except block_num filename
    S.questionnaire_params = {'ShockBlockparams'}; % for end of block assessment

    allWraps = dir(['~/Experiments/AssocMem/data/Quest/AssocMem_*_block', num2str(block_num),'*.mat']);

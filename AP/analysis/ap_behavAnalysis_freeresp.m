function [freerespData] = ap_behavAnalysis_freeresp(subID)
...
freerespMat = [subID '_freeresp_cat.mat']; % use this instead of concat bc it has resp mapping
% freerespMat = [subID '_freeresp_cat_v2.mat']; % use this instead of concat bc it has resp mapping
load(freerespMat);
nRuns = size(freerespData,2);
freerespData = freerespData(nRuns); % change!
...
save([subID '_freeresp_cat_acc.mat'],'freerespData');
